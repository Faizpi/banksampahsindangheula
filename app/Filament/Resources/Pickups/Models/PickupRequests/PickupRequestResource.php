            ...
            ->recordActions([
                ...
                Action::make('schedule')
                    ...
                    ->schema([
                        ...
                        DatePicker::make('scheduled_date')->label('Tanggal jadwal')->helperText('Pilih besok hingga batas horizon penjemputan.')->minDate(today('Asia/Jakarta')->addDay())->maxDate(today('Asia/Jakarta')->addDays((int) config('app.pickup_booking_horizon_days', 30)))->required(),
                    ])
