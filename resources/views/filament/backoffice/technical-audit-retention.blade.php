<x-filament-panels::page>
    ...
    <section class="rounded-xl border border-danger-200 bg-danger-50 p-5 shadow-sm" aria-labelledby="technical-retention-title">
        ...
        <div class="mt-5 flex max-w-3xl flex-col gap-3 sm:flex-row sm:items-end">
            <label class="block flex-1 text-sm font-medium text-gray-800">Hapus sebelum tanggal<input wire:model="retentionBefore" type="date" required class="mt-1 block min-h-11 w-full rounded-lg border-gray-300 text-sm shadow-sm"></label>
