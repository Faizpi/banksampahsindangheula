            ...
            <div class="grid gap-4">
                ...
                <div wire:ignore class="rounded-xl border border-border bg-warm-canvas p-4" data-photo-picker data-photo-picker-max="1" data-photo-picker-limit="1048576" data-photo-picker-remove-method="clearEvidence" data-photo-picker-confirm-method="confirmEvidenceUpload">
                    ...
                    <div class="mt-3 flex flex-col gap-2 sm:flex-row">
                        <label for="pickup-evidence" data-photo-picker-trigger="camera" class="inline-flex min-h-touch cursor-pointer items-center justify-center gap-2 rounded-md border border-border bg-surface px-5 text-label font-semibold text-deep-green transition hover:border-forest-600 hover:bg-success-bg focus:outline-none focus:ring-2 focus:ring-focus">
