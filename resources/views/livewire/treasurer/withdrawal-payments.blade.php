        ...
        <x-ui.panel wire:key="withdrawal-payment-{{ $selectedWithdrawal->id }}" title="Verifikasi dan bukti pembayaran" description="Pastikan nama penerima dan nominal sesuai sebelum pembayaran dicatat." state="success">
            <div class="grid gap-4">
                ...
                <div wire:ignore wire:key="payment-proof-picker-{{ $selectedWithdrawal->id }}" class="rounded-md border border-border bg-warm-canvas p-4" data-photo-picker data-photo-picker-max="1" data-photo-picker-limit="1048576" data-photo-picker-remove-method="clearProof">
                    ...
                    <input id="payment-proof" wire:model="proof" type="file" accept="image/jpeg,image/png" data-photo-picker-input data-photo-picker-property="proof" class="mt-3 block min-h-touch w-full rounded-md border-2 border-dashed border-border bg-surface p-4 text-body text-text-secondary transition hover:border-forest-600 focus:outline-none focus:ring-2 focus:ring-focus">
