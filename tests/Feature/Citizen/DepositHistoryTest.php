...
final class DepositHistoryTest extends TestCase
{
    ...
    public function test_citizen_can_filter_only_their_deposits_by_number_status_and_date_range(): void
    {
        ...
        $matching = $this->deposit($citizen, 'DEP-CARI-001', Deposit::STATUS_FINAL, '2026-08-10');
        $this->deposit($citizen, 'DEP-LAIN-002', Deposit::STATUS_REJECTED, '2026-08-11');
        $this->deposit($citizen, 'DEP-LAMA-003', Deposit::STATUS_FINAL, '2026-08-01');
        $this->deposit($otherCitizen, 'DEP-CARI-RAHASIA', Deposit::STATUS_FINAL, '2026-08-10');
    ...
    private function deposit(User $citizen, string $number, string $status, string $occurredAt): Deposit
    {
